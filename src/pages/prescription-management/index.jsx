...
const PrescriptionManagement = () => {
  ...
  const handleApproveRefill = (request) => {
    alert(`Refill approved for ${request?.patientName} - ${request?.medication}`);
  };

  const handleDenyRefill = (request) => {
    alert(`Refill denied for ${request?.patientName} - ${request?.medication}`);
  };
